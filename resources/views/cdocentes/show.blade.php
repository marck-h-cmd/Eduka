            ...
            <div class="col-12">
                <div class="box_block">
                    <button class="estilo-info btn btn-block text-left rounded-0 btn_header header_6" type="button"
                        ...
                        <i class="fas fa-user-check m-1"></i>&nbsp;Detalles de docente: {{ $docente->persona->nombres }} {{ $docente->persona->apellidos }}
                    ...
                    <div class="card-body info">
                        <div class="d-flex ">
                            ...
                            <div class="p-2 flex-fill">
                                <p>
                                    Aquí puedes ver toda la información detallada de la docente seleccionada.
                                </p>
                                <p>
                    ...
                    <div class="collapse show" id="collapseExample0">
                        <div class="card card-body rounded-0 border-0 pt-0 pb-2"
                            ...
                            <div class="row form-bordered">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="detail-value bg-light p-2 rounded">{{ $docente->id_persona }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="detail-value">
                                            <span class="badge badge-{{ $docente->persona->estado == 'Activo' ? 'success' : 'danger' }} badge-detail">
                                                <i class="fas fa-{{ $docente->persona->estado == 'Activo' ? 'check-circle' : 'times-circle' }} mr-1"></i>
                            ...
                            <div class="row form-bordered">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="detail-value bg-light p-2 rounded">{{ $docente->persona->nombres }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="estilo-info">Apellidos</label>
                                        <div class="detail-value bg-light p-2 rounded">{{ $docente->persona->apellidos }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row form-bordered">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="detail-value bg-light p-2 rounded">{{ $docente->persona->dni }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="estilo-info">Teléfono</label>
                                        <div class="detail-value bg-light p-2 rounded">{{ $docente->persona->telefono ?: 'No especificado' }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row form-bordered">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="estilo-info">Email Personal</label>
                                        <div class="detail-value bg-light p-2 rounded">{{ $docente->persona->email ?: 'No especificado' }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="detail-value bg-light p-2 rounded">
                                            ...
                                            @elseif($docente->persona->genero == 'Otro')
                            ...
                            <div class="row form-bordered">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="detail-value bg-light p-2 rounded">
                                            @if($docente->persona->fecha_nacimiento)
                                                <i class="fas fa-calendar-alt text-info mr-1"></i>{{ $docente->persona->fecha_nacimiento->format('d/m/Y') }}
                                                <small class="text-muted ml-2">({{ \Carbon\Carbon::parse($docente->persona->fecha_nacimiento)->age }} años)</small>
                                            @else
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="detail-value bg-light p-2 rounded">{{ $docente->persona->direccion ?: 'No especificada' }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row form-bordered">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="estilo-info">ID Docente</label>
                                        <div class="detail-value bg-light p-2 rounded">{{ $docente->id_docente }}</div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="estilo-info">Email Universitario</label>
                                        <div class="detail-value bg-light p-2 rounded">{{ $docente->emailUniversidad }}</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row form-bordered">
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="estilo-info">Fecha de Contratación</label>
                                        <div class="detail-value bg-light p-2 rounded">
                                            @if($docente->fecha_contratacion)
                                                <i class="fas fa-calendar-alt text-info mr-1"></i>{{ $docente->fecha_contratacion->format('d/m/Y') }}
                                            @else
                                                <i class="fas fa-calendar-times text-muted mr-1"></i>No especificada
                                            @endif
                                        </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        <label class="estilo-info">Estado Docente</label>
                                        <div class="detail-value">
                                            <span class="badge badge-{{ $docente->estado == 'Activo' ? 'success' : 'danger' }} badge-detail">
                                                <i class="fas fa-{{ $docente->estado == 'Activo' ? 'check-circle' : 'times-circle' }} mr-1"></i>
                                                {{ $docente->estado }}
                                            </span>
                                        </div>
                                    </div>
                            ...
                            <!-- ESPECIALIDADES -->
                            @if ($docente->especialidades->count() > 0)
                                <div class="row form-bordered">
                                    <div class="col-12">
                                        <div class="form-group">
                                            <label class="estilo-info">Especialidades Asignadas</label>
                                            <div class="detail-value">
                                                @foreach ($docente->especialidades as $especialidad)
                                                    <span class="badge badge-primary badge-detail mr-2 mb-1">
                                                        <i class="fas fa-book mr-1"></i>{{ $especialidad->nombre }}
                                                    </span>
                                                @endforeach
                                            </div>
                                        </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="detail-value">
                                    @if ($docente->persona->roles->count() > 0)
                                        @foreach ($docente->persona->roles as $rol)
                            ...
                            <!-- USUARIOS ASOCIADOS -->
                            @if ($docente->persona->usuarios->count() > 0)
                                <div class="form-group">
                                    ...
                                    <div class="table-responsive mt-2">
                                        <table class="table table-hover table-custom text-center" style="border: 1px solid #0A8CB3; border-radius: 10px; overflow: hidden;">
                                            ...
                                            <tbody>
                                                @foreach ($docente->persona->usuarios as $usuario)
                                                    <tr>
                            ...
                            <div class="row mt-4">
                                <div class="col-12 d-flex justify-content-center">
                                    <div style="display: flex; align-items: center; gap: 15px;">
                                        <a href="{{ route('docentes.edit', $docente) }}" class="btn btn-warning" style="width: 160px; height: 38px; padding: 6px 12px; display: inline-block; text-align: center; text-decoration: none; line-height: 26px; vertical-align: middle;">
                                            <i class="fas fa-edit"></i> Editar docente
                                        </a>
                                        <a href="{{ route('docentes.index') }}" class="btn btn-secondary" style="width: 180px; height: 38px; padding: 6px 12px; display: inline-block; text-align: center; text-decoration: none; line-height: 26px; vertical-align: middle;">
