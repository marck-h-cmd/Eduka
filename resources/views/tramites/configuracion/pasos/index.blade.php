...
@section('titulo', 'Gestión de Pasos')
        ...
        <div class="col-12">
            <div class="box_block">
                ...
                <button class="estilo-info btn btn-block text-left rounded-0 btn_header header_6"
                    ...
                    <i class="fas fa-shoe-prints m-1"></i> Gestión de Pasos
                ...
                <div class="card-body info">
                    <div class="d-flex">
                        ...
                        <div class="p-2 flex-fill">
                            <p>Administre los pasos configurables del sistema.
                                Estos pasos se asignan a procesos y definen la secuencia.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card card-body rounded-0 border-0 pt-0 pb-2">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-6 mb-2">
                                <a href="{{ route('pasos.create') }}" class="btn btn-primary w-100">
                                    <i class="fa fa-plus mx-2"></i> Nuevo Paso
                                </a>
                            </div>
                                ...
                                <form method="GET" class="w-100">
                                    <div class="input-group">
                                        <input name="buscarpor" class="form-control mt-3" type="search"
                                            placeholder="Buscar paso..." value="{{ $buscarpor }}">
                        ...
                        <div class="table-responsive mt-3">
                            @include('tramites.configuracion.pasos.pasos')
                        </div>
...
function confirmDelete(id, nombre) {
    Swal.fire({
        title: '¿Está seguro?',
        text: `¿Desea cambiar el estado del paso "${nombre}" a Inactivo?`,
        icon: 'warning',
