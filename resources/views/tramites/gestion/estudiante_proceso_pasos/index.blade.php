...
@section('titulo', 'Gestión de Pasos del Expediente')
        ...
        <div class="col-12">
            <div class="box_block">
                ...
                <button class="estilo-info btn btn-block btn_header header_6 text-left rounded-0"
                    data-toggle="collapse" data-target="#collapsePasos" aria-expanded="true"
                    style="background:#0A8CB3!important;color:white;">
                    <i class="fas fa-clipboard-check m-1"></i> Gestión de Pasos del Expediente
                ...
                <div class="card-body info">
                    <div class="d-flex">
                        ...
                        <div class="p-2 flex-fill">
                            <p>Administre los pasos asignados a cada expediente del estudiante.
                                Incluye fechas, validaciones y estados del proceso.</p>
                        </div>
                    </div>
                </div>

                <div class="collapse show" id="collapsePasos">
                    <div class="card card-body rounded-0 border-0 pt-0 pb-2">

                        <div class="row align-items-center">

                            <div class="col-md-6 mb-2">
                                <a href="{{ route('estudiante_proceso_pasos.create') }}" class="btn btn-primary w-100">
                                    <i class="fa fa-plus mx-2"></i> Asignar Paso
                                </a>
                            </div>
                                ...
                                <form method="GET" class="w-100">
                                    <div class="input-group">
                                        <input name="buscarpor" class="form-control mt-3" type="search"
                                            placeholder="Buscar por paso o código expediente..."
                                            value="{{ $buscarpor }}">
                        ...
                        <div class="table-responsive mt-3">
                            @include('tramites.gestion.estudiante_proceso_pasos.pasos')
                        </div>
...
function confirmDelete(id, nombre) {
    Swal.fire({
        title: '¿Está seguro?',
        text: `¿Desea marcar este paso como Vencido?`,
        icon: 'warning',
