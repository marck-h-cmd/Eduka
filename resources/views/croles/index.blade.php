                    ...
                    <div class="card-body info">
                        <div class="d-flex ">
                            ...
                            <div class="p-2 flex-fill">
                                <p>
                                    En esta sección, podrás añadir nuevos roles y consultar la información de los que ya
                                    están registrados.
                                </p>
                                <p>
                                    Estimado Usuario: Asegúrate de revisar cuidadosamente los datos antes de guardarlos, ya
                                    que los roles son utilizados para gestionar los permisos y acceso en el sistema.
                                </p>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6 mb-md-0 d-flex justify-content-start">
                                    <a href="{{ route('roles.create') }}" class="btn btn-primary w-100"
                                        id="nuevoRegistroBtn" style="background: #007bff !important; border: none;">
                                    ...
                                    <form id="formBuscar" method="GET" class="w-100" style="max-width: 100%;">
                                        <div class="input-group">
                                            <input name="buscarpor" id="inputBuscar" class="form-control mt-3"
                                                type="search" placeholder="Buscar rol" aria-label="Search"
                                                autocomplete="off" style="border-color: #007bff;">
                                            ...
                                            <tr>
                                                ...
                                                <td class="btn-action-group">
                                                    <a href="{{ route('roles.show', $rol->id_rol) }}"
                                                        class="btn btn-link btn-sm p-0 btn-ver-rol" title="Ver">
                                                        <i class="fas fa-eye"
                                                            style="color: #17a2b8; font-size: 1.2rem;"></i>
                                                    </a>
                                                    <a href="{{ route('roles.edit', $rol->id_rol) }}"
                                                        class="btn btn-link btn-sm p-0 btn-editar-rol" title="Editar">
                                                        <i class="fas fa-pen"
                                                            style="color: #007bff; font-size: 1.2rem;"></i>
                                                    </a>
                                                    <button type="button" class="btn btn-link btn-sm p-0 btn-eliminar-rol"
                                                        title="Eliminar"
                                                        onclick="confirmarEliminar({{ $rol->id_rol }}, '{{ $rol->nombre }}')">
                                                        <i class="fas fa-times"
                                                            style="color: #dc3545; font-size: 1.3rem;"></i>
                                                    </button>
                                                    <form id="delete-form-{{ $rol->id_rol }}"
                                                        action="{{ route('roles.destroy', $rol->id_rol) }}" method="POST"
                                                        class="d-none">
                                                        @csrf
                                                        @method('DELETE')
                                                    </form>
