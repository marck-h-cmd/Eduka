...
<div>
    <div class="card" style="border: none">
        <div class="btn btn-block text-left rounded-0 btn_header header_6" type="button" data-toggle="collapse"
            data-target="#collapseExample4" aria-expanded="true" aria-controls="collapseExample"
        ...
        <div class="card-body collapse show" id="collapseExample4"
            ...
            <div class="row align-items-center">
                ...
                <div class="col-md-6 mb-md-0 d-flex justify-content-start">
                    <a class="btn btn-primary w-100" id="Repre1RegistroBtn" style="color: #f1f1f1; font-weight: bold">
                ...
                <div class="col-md-6 d-flex justify-content-md-end justify-content-center">
                    <form id="formBuscar" class=" w-100" style="max-width: 100%;" autocomplete="off">
                        <div class="input-group">
                            <input maxlength="8" id="inputBuscar" name="buscarpor" class="form-control mt-1"
                                type="search" placeholder="Buscar al padre de familiar por N.º DNI" aria-label="Search"
                                style="border-color: #F59617;">
                            <button id="btnBuscar" class="btn btn-primary nuevo-boton mt-1" type="button"
...
@endif
        -->
                ...
                <div id="formPadreVer" class="container-fluid">
                                    ...
                                    <div class="card" style="border: none">
                                        ...
                                        <div class="card-body "
                                            ...
                                            <div class="row form-group">
                                                <label class="col-md-2 col-form-label">Apellido
                                                    Paterno
                                                    <span style="color: #FF5A6A">(*)</span></label>
                                                <div class="col-md-4">
                                                    <input type="text"
                                                ...
                                                <div class="col-md-4">
                                                    <input type="text"
                                                        ...
                                                        value="{{ old('apellidoMaternoRepresentante1') }}" readonly>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text"
                                                        ...
                                                        id="nombreRepresentante1" name="nombreRepresentante1"
                                                        placeholder="Nombres" maxlength="100"
                                                        value="{{ old('nombreRepresentante1') }}" readonly>
                                            ...
                                            <div class="row form-group">
                                                <label class="col-md-2 col-form-label">Parentesco
                                                    <span style="color: #FF5A6A">(*)</span>
                                                </label>
                                                <div class="col-md-4">
                                                    <select
                                                        class="form-control @error('parentescoRepresentante1') is-invalid @enderror"
                                                        id="parentescoRepresentante1" name="parentescoRepresentante1"
                                                        readonly>
                                                ...
                                                <label class="col-md-2 col-form-label">N.°
                                                    DNI <span style="color: #FF5A6A">(*)</span></label>
                                                <div class="col-md-4">
                                                    <input type="text" class="form-control" id="dniRepresentante1"
                                                        name="dniRepresentante1" maxlength="8" placeholder="N.° DNI"
                                                        value="{{ old('dniRepresentante1') }}" readonly>
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-10">
                                                    <input type="text" class="form-control"
                                                        id="ocupacionRepresentante1" name="ocupacionRepresentante1"
                                                        placeholder="Ocupación del representante"
                                                        value="{{ old('ocupacionRepresentante1') }}" maxlength="100"
                                                        readonly>
                                    ...
                                    <div class="card" style="border: none">
                                        ...
                                        <div class="card-body"
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col-md-4">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text"
                                                            ...
                                                            id="celularRepresentante1" name="celularRepresentante1"
                                                            placeholder="N.° celular" maxlength="9"
                                                ...
                                                <label class="col-md-2 col-form-label">Celular
                                                    alternativo</label>
                                                <div class="col-md-4">
                                                    <div class="input-group">
                                                ...
                                                <div class="col-md-10">
                                                    <div class="input-group">
                                                        <input type="text"
                                                            ...
                                                            id="correoRepresentante1" name="correoRepresentante1"
                                            ...
                                            <div class="row form-group">
                                                <label class="col-md-2 col-form-label">Dirección
                                                    completa <span style="color: #FF5A6A">(*)</span></label>
                                                <div class="col-md-10">
                                                    <input type="text"
                                                        class="form-control @error('direccionRepresentante1') is-invalid @enderror"
                                                        id="direccionRepresentante1" name="direccionRepresentante1"
                                                        placeholder="Dirección completa" maxlength="20"
                                                        value="{{ old('direccionRepresentante1') }}" readonly>
...
<div>
    <div class="card" style="border: none">
        <div class="btn btn-block text-left rounded-0 btn_header header_6" type="button" data-toggle="collapse"
            data-target="#collapseExample5" aria-expanded="true" aria-controls="collapseExample"
            style="background: #0A8CB3 !important; font-weight: bold; color: white;"
            style="background: #E0F7FA; color: #0A8CB3; font-weight: bold; border: 2px solid #86D2E3; border-bottom: 2px solid #86D2E3; padding: 6px 20px; border-radius:4px 4px 0px 0px;">
            Datos de la Madre
        </div>

        <div class="card-body collapse show" id="collapseExample5"
            style="border: 2px solid #86D2E3; border-top: none; border-radius: 0px 0px 4px 4px !important;">
            <div class="row align-items-center">
                <!-- Botón a la izquierda -->
                <div id="btnBuscar22" class="col-md-6 mb-md-0 d-flex justify-content-start">
                    <a class="btn btn-primary w-100" id="Repre2RegistroBtn" style="color: #f1f1f1">
                ...
                <!-- Formulario de búsqueda a la derecha -->
                <div id="" class="col-md-6 d-flex justify-content-md-end justify-content-start">
                    <div id="buscadorOcultar" class="input-group w-100 mt-1 h-5" style="max-width: 100%;">
                        <input maxlength="8" id="inputBuscar2" name="buscarpor" class="form-control"
                            type="search" placeholder="Buscar a la madre de familia por N.° de DNI"
                            aria-label="Search" style="border-color: #F59617;">
                        <button id="btnBuscar2" class="btn btn-primary nuevo-boton" type="button"
                            style="border-top-left-radius: 0 !important; border-bottom-left-radius: 0 !important;">
                            <i class="fas fa-search"></i>
                        </button>
                    </div>
                ...
                <script>
                    document.addEventListener('DOMContentLoaded', function() {
                        ...
                        const formMadrever = document.getElementById('formMadre');
const bysss = document.getElementById('btnBuscar22');
const ocultarBuscador = document.getElementById('buscadorOcultar');
                        // 1. Si se escribe en el buscador, desactiva el botón "Registrar"
                        ...
                        btnRegistrar2.addEventListener('click', function(e) {
                            ...
                            //formMadrever.hidden = false;
                            //ocultarBuscador.hidden = true;
                           // bysss.classList.add('col-md-12');
                        });
                    });
                </script>
                <script>
            ...
            <div id="formMadre" class="container-fluid">
                <div class="row margen-movil">
                    <div class="col-12">
                                ...
                                <div class="card" style="border: none">
                                    ...
                                    <div class="card-body"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-4">
                                                <input type="text"
                                                    ...
                                                    placeholder="Apellido materno" maxlength="100"
                                                    value="{{ old('apellidoMaternoRepresentante2') }}" readonly>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text"
                                                    ...
                                                    id="nombreRepresentante2" name="nombreRepresentante2"
                                                    placeholder="Nombres" maxlength="100"
                                                    value="{{ old('nombreRepresentante2') }}" readonly>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-4">
                                                <select
                                                    ...
                                                    id="parentescoRepresentante2" name="parentescoRepresentante2"
                                                    readonly>
                                                    <option value="" disabled
                                            ...
                                            <label class="col-md-2 col-form-label">N.°
                                                DNI <span style="color: #FF5A6A">(*)</span></label>
                                            <div class="col-md-4">
                                                <input type="text" class="form-control" id="dniRepresentante2"
                                                    name="dniRepresentante2" maxlength="8" placeholder="N.° DNI"
                                                    value="{{ old('dniRepresentante2') }}" readonly>
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text" class="form-control"
                                                    id="ocupacionRepresentante2" name="ocupacionRepresentante2"
                                                    placeholder="Ocupación del representante"
                                                    value="{{ old('dniRepresentante2') }}" maxlength="100" readonly>
                                            ...
                                            <div class="col-md-4">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="celularRepresentante2" name="celularRepresentante2"
                                                        placeholder="N.° celular" maxlength="9"
                                            ...
                                            <div class="col-md-10">
                                                <div class="input-group">
                                                    ...
                                                    <input type="text"
                                                        ...
                                                        id="correoRepresentante2" name="correoRepresentante2"
                                                        placeholder="correo@estudiante.com" maxlength="100"
                                        ...
                                        <div class="row form-group">
                                            ...
                                            <div class="col-md-10">
                                                <input type="text"
                                                    ...
                                                    id="direccionRepresentante2" name="direccionRepresentante2"
                                                    placeholder="Dirección completa" maxlength="20"
                                                    value="{{ old('direccionRepresentante2') }}" readonly>
