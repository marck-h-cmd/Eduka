                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <select class="form-control @error('email') is-invalid @enderror"
                                                ...
                                                <option value="yahoo.com" {{ old('email_domain', $emailDomain) === 'yahoo.com' ? 'selected' : '' }}>yahoo.com</option>
                                                <option value="live.com" {{ old('email_domain', $emailDomain) === 'live.com' ? 'selected' : '' }}>live.com</option>
                                            </select>
                                        </div>
                                        @error('email')
                                                ...
                                                <div class="card role-card border"
                                                    ...
                                                    <div class="card-body text-center p-4">
                                                        <input class="form-check-input d-none" type="radio"
                                                            ...
                                                            id="rol_{{ $rol->id_rol }}"
                                                            {{ $persona->roles->where('id_rol', $rol->id_rol)->count() > 0 || old('rol') == $rol->id_rol ? 'checked' : '' }}>
