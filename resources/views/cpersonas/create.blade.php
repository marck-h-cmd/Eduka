                ...
                <div class="box_block">
                    ...
                    <div class="collapse show" id="collapseExample0">
                        <div class="card card-body rounded-0 border-0 pt-0 pb-2"
                            ...
                            <form action="{{ route('personas.store') }}" method="POST" id="personaForm">
                                @csrf
                                <div class="row">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text"
                                                ...
                                                name="telefono" value="{{ old('telefono') }}" maxlength="9"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text"
                                                    ...
                                                    value="{{ old('email_username', explode('@', old('email'))[0] ?? '') }}"
                                                ...
                                                <select class="form-control @error('email') is-invalid @enderror"
                                                    ...
                                                    <option value="hotmail.com"
                                                        {{ (explode('@', old('email'))[1] ?? '') === 'hotmail.com' ? 'selected' : '' }}>
                                                        hotmail.com</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="date"
                                                ...
                                                value="{{ old('fecha_nacimiento') }}" style="border-color: #007bff;"
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control @error('direccion') is-invalid @enderror" id="direccion" name="direccion"
                                                rows="3" style="border-color: #007bff;">{{ old('direccion') }}</textarea>
                                            @error('direccion')
                                                <span class="invalid-feedback" role="alert">
                                                    <strong>{{ $message }}</strong>
                                                </span>
    ...
    <script>
        ...
        function validarEmailManual(emailValue) {
            ...
            if (regexResult) {
                ...
                $('#emailHelp').removeClass('text-warning text-danger').addClass('text-success').text(
                    'Verificando email...');
                $('#email').removeClass('is-invalid').addClass('is-valid');
                verificarEmailGlobal(email);
            } else {
                // Email en proceso de escritura - mostrar feedback básico
                $('#emailHelp').removeClass('text-success text-danger').addClass('text-warning').text(
                    'Formato de email incompleto');
        ...
        function verificarEmailGlobal(email) {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.existe) {
                        $('#emailHelp').removeClass('text-success text-warning').addClass('text-danger').text(
                            response.mensaje);
                        $('#email').addClass('is-invalid').removeClass('is-valid');
                    } else {
                        $('#emailHelp').removeClass('text-danger text-warning').addClass('text-success').text(
                            response.mensaje);
                        $('#email').removeClass('is-invalid').addClass('is-valid');
                    }
                },
